...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'),				//стартовый символ, дно стека
		6,											//количество правил
		Rule(NS('S'), ERROR_ENTRY + 0,			//Неверная структура программы
			6,		//S →	m{NrE;};	|	tfi(F){NrE;};S	|	m{NrE;};S	|	tfi(F){NrE;}; | i{NrE;} | tfi(){NrE;};S
			Rule::Chain(7, TS('m'), TS('{'), NS('N'), TS('g'), NS('E'), TS(';'), TS('}')),
			Rule::Chain(4, TS('m'), TS('{'), NS('N'), TS('}')),
			Rule::Chain(13, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), TS('g'), NS('E'), TS(';'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(14, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('g'), NS('E'), TS(';'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(13, TS('t'), TS('f'), TS('i'), TS('('), TS(')'), TS('{'), NS('N'), TS('g'), NS('E'), TS(';'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(12, TS('t'), TS('f'), TS('i'), TS('('), TS(')'), TS('{'), TS('g'), NS('E'), TS(';'), TS('}'), TS(';'), NS('S'))
		),
		Rule(NS('N'), GRB_ERROR_SERIES + 1,			//Операторы программы
			...
			Rule::Chain(11, TS('?'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}'), TS('!'), TS('{'), NS('N'), TS('}')),
			Rule::Chain(12, TS('?'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}'), TS('!'), TS('{'), NS('N'), TS('}'), NS('N'))
		),
